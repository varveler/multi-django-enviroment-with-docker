...
DATABASES = {
    'default': {
        ...
        'NAME': get_env_variable('SECRET_DB_NAME'),
        'USER': get_env_variable('SECRET_DB_USER'),
        'PASSWORD': get_env_variable('SECRET_DB_PASSWORD'),
        'HOST': 'db',
        'PORT': '3306'
        # 'OPTIONS': {
        #     'read_default_file': get_env_variable('DB_CONFIG_FILE'),
        # },
    }
}
